...
function FilterStickerContent() {
  ...
  // Default di set ke true (SEBELUM) pas awal dibuka
  ...
  const handleLanjut = () => {
    localStorage.setItem("selected_frame", frameId);
    ...
    router.push(`/result?frame=${frameId}`);
  };
  ...
  return (
    <main className="relative flex h-screen flex-col items-center pt-4 overflow-hidden select-none" style={{ backgroundColor: '#E3D5D5' }}>
      ...
      {/* 2. MAIN LAYOUT (Frame Kiri + Workspace Kanan) */}
      <div className="w-full max-w-[1400px] flex-1 flex flex-row gap-16 justify-center px-4 md:px-8 overflow-hidden pb-4">
        
        {/* === SISI KIRI: PREVIEW FRAME (DIEM) === */}
        <div className="flex flex-col items-center flex-shrink-0 h-full z-30 w-[360px] relative">
          ...
          <div className="relative shrink-0">
            {/* FRAME KIRI */}
            <div className="w-[280px] h-[630px] bg-white border-[1.5px] border-[#54868A] rounded-[24px] flex items-center justify-center shadow-md p-4">
              <div className="w-[240px] h-[590px] bg-[#545151] border-[1.5px] border-[#54868A] rounded-[11px] flex items-center justify-center relative overflow-hidden">
                <div ref={frameRef} className="relative w-full h-full">
                  ...
                  <img src={currentFrame.image} className="absolute inset-0 w-full h-full object-fill z-20 pointer-events-none" alt="Frame" />
            ...
            {/* FIX: BADGE BINTANG ORIGINAL SEKARANG LANGSUNG MUNCUL DARI AWAL */}
            {selectedFilter === "ORIGINAL" && (
              <div className="absolute top-[45%] -right-[95px] bg-[#624E38] border-[1.5px] border-[#CCAE19] px-3 py-1.5 rounded-full shadow-md z-40 flex items-center gap-1.5 animate-fade-in">
        ...
        <div className="flex flex-col gap-6 w-[856px] flex-shrink-0 h-full relative z-40">
          ...
          {/* TOMBOL LANJUT DI TENGAH BAWAH GLOBALY */}
          <div className="w-full flex justify-center mt-auto shrink-0 py-2">
            <button 
