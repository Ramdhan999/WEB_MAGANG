...
export default function PembayaranPage() {
  ...
  const packageData: Record<string, any> = {
    solo: { title: "Glambot Solo", price: "Rp. 35,000", avatarBg: "linear-gradient(147.96deg, #FEA685 39.28%, #FDBB9E 113.17%)", img: "/paket1.png" },
    duo: { title: "Glambot Duo", price: "Rp. 45,000", avatarBg: "linear-gradient(147.96deg, #BA96FD 39.28%, #CBAFFE 113.17%)", img: "/paket2.png" },
    group: { title: "Glambot Group", price: "Rp. 55,000", avatarBg: "linear-gradient(147.96deg, #6FEABC 39.28%, #94F0CC 113.17%)", img: "/paket3.png" },
    premium: { title: "Glambot Premium", price: "Rp. 75,000", avatarBg: "linear-gradient(147.96deg, #F6CA7E 39.28%, #FCD79A 113.17%)", img: "/paket4.png" },
  };
      ...
      <div className="w-full flex flex-col items-center flex-1 justify-center max-w-[1440px] z-10">
        ...
        >
          <div 
            ...
            style={{ background: currentPackage.avatarBg }}
          >
            <img src={currentPackage.img} alt="Package" className="w-[43px] h-[43px] object-contain" />
          </div>
        ...
        {/* METODE PEMBAYARAN 2: KODE VOUCHER */}
        <Link 
