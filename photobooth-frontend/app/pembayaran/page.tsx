...
export default function PembayaranPage() {
  ...
  return (
    ...
    >
      ...
      <Link href="/kupon" className="group flex items-center justify-between px-6 mb-12 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_10px_20px_rgba(0,0,0,0.3)] hover:border-[#6AC5C3]" style={{ width: '644px', height: '108px', background: '#2E4F4D', border: '1.5px solid #54868A', borderRadius: '18px', boxSizing: 'border-box' }}>
        <div className="flex items-center gap-6">
          <div className="flex items-center justify-center transition-transform group-hover:scale-110" style={{ width: '78px', height: '76px', background: '#B3D2D1', borderRadius: '9px' }}>
